...
<div class="row">
    <button class="col-3 bg-success m-2 text-center text-white" id="Test1">coba 1</button>
    <button class="col-3 bg-success m-2 text-center text-white" id="Test2">coba 2</button>
    <button class="col-3 bg-success m-2 text-center text-white" id="Test3">coba 3</button>
</div>
<div class="row">
